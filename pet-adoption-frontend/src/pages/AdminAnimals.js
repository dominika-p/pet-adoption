		...
		<div className='admin-section'>
			...
			<div className='animal-form'>
				...
				<div className='form-row'>
					...
					<div className='inline-label'>
						<label>Płeć:</label>
						<select value={newAnimal.gender} onChange={e => setNewAnimal({ ...newAnimal, gender: e.target.value })}>
					...
					<div className='inline-label'>
						...
						<div className='age-inputs'>
							<input
								...
								onChange={e =>
									setNewAnimal({ ...newAnimal, ageYears: e.target.value === '' ? '' : Number(e.target.value) })
								}
							/>
							<input
								type='number'
								...
								onChange={e =>
									setNewAnimal({ ...newAnimal, ageMonths: e.target.value === '' ? '' : Number(e.target.value) })
								}
							/>
						</div>
					</div>
				...
				<div className='form-row'>
					...
					<div className='inline-label'>
						...
						<select value={newAnimal.size} onChange={e => setNewAnimal({ ...newAnimal, size: e.target.value })}>
				...
				<button onClick={addAnimal} className='submit-btn'>
					Dodaj zwierzaka
				</button>
			</div>
				...
				<div className='edit-modal-overlay'>
					<div className='edit-modal-window'>
							...
							<div className='edit-modal-grid'>
								...
								<div className='edit-modal-field'>
									...
									<div style={{ display: 'flex', gap: '5px' }}>
										<input
											type='number'
											value={editingAnimal.ageYears}
											onChange={e => setEditingAnimal({ ...editingAnimal, ageYears: parseInt(e.target.value) || 0 })}
										/>
										<input
											type='number'
											value={editingAnimal.ageMonths}
											onChange={e => setEditingAnimal({ ...editingAnimal, ageMonths: parseInt(e.target.value) || 0 })}
										/>
									</div>
								</div>
								...
								<div className='edit-modal-field'>
									...
									<select
										...
										onChange={e => setEditingAnimal({ ...editingAnimal, size: e.target.value })}>
										<option value='Mały'>Mały</option>
										<option value='Średni'>Średni</option>
										<option value='Duży'>Duży</option>
									</select>
								...
								<div className='edit-modal-field'>
									...
									<select
										value={editingAnimal.goodWithAnimals}
										onChange={e => setEditingAnimal({ ...editingAnimal, goodWithAnimals: e.target.value })}>
								...
								<div className='edit-modal-field'>
									...
									<select
										value={editingAnimal.goodWithKids}
										onChange={e => setEditingAnimal({ ...editingAnimal, goodWithKids: e.target.value })}>
										<option value='Tak'>Tak</option>
										<option value='Nie'>Nie</option>
									</select>
								</div>
								...
								<div className='edit-modal-field edit-full-row'>
									...
									<textarea
										value={editingAnimal.history}
										onChange={e => setEditingAnimal({ ...editingAnimal, history: e.target.value })}
									/>
								</div>
							</div>
						</div>
						...
						<div className='edit-modal-actions-sidebar'>
							<button className='edit-cancel-btn' onClick={() => setEditingAnimal(null)}>
								Anuluj
							</button>
							<button className='edit-save-btn' onClick={() => handleUpdateAnimal(editingAnimal)}>
								Zapisz
							</button>
						</div>
					</div>
