...
const VolunteeringPage = () => {
	return (
		<div className='volunteering-page'>
			{}
			<header className='volunteer-header' style={{ backgroundImage: "url('/img/wolontariat.jpg')" }}>
			...
			<div className='volunteer-wrapper volunteer-wrapper-overlap'>
				<p className='volunteer-intro'>
					Zostań wolontariuszem naszego schroniska! Możesz pomagać w opiece nad psami i kotami, uczestniczyć w spacerach
					i zabawach, a także zbierać punkty, które możesz wymienić na nagrody.
				</p>
				...
				<div className='volunteer-info'>
					...
					<p>
						Aby dołączyć do wolontariatu, <Link to='/volunteer-login'>zaloguj się lub zarejestruj konto</Link>.
					</p>
				</div>
			</div>
		</div>
